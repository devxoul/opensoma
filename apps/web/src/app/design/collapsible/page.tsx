      ...
      <Card className="p-6">
        <div className="max-w-md space-y-4">
          <Collapsible defaultOpen>
            ...
            <CollapsiblePanel>
              <p className="text-sm text-foreground-muted">
                We offer a 30-day money-back guarantee for all purchases. If you are not satisfied
          ...
          <Collapsible>
            ...
            <CollapsiblePanel>
              <p className="text-sm text-foreground-muted">
                Yes, we ship to over 100 countries worldwide. Shipping rates and delivery times
